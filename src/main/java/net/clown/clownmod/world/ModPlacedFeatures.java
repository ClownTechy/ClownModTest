...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, END_RAW_SINGULARITY_BLOCK_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.END_RAW_SINGULARITY_BLOCK_KEY),
                ModOrePlacement.modifiersWithCount(4,
                        HeightRangePlacementModifier.trapezoid(YOffset.fixed(15), YOffset.fixed(60))));
